...
namespace RandevuSistemiNew.Models
{
    ...
    public partial class RandevuSistemiEntities : DbContext
    {
        public RandevuSistemiEntities()
            : base("name=RandevuSistemiEntities")
        {
        }
        ...
        public virtual DbSet<DoktorMusaitligi> DoktorMusaitligi { get; set; }
